...
\begin{table}[h!]
  \centering
  \caption{Various parameter test case runtimes in seconds. We set $q = p$}
...
\centering
  ...
  \caption{Log-log plot of $n$ versus runtime with $p = 499$, $m = 2$}
\end{figure}
