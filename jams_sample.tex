%------------------------------------------------------------------------------
% Beginning of jams_sample.tex
%------------------------------------------------------------------------------
%
% AMS-LaTeX version 2 sample file for journals, based on amsart.cls.
%
%        ***     DO NOT USE THIS FILE AS A STARTER.      ***
%        ***       USE THE JAMS-L-TEMPLATE FILE.         ***
%
% Please see the README-JAMS-OVERLEAF.TXT file for more information.
%
...
\title{Journal of the American Mathematical Society Sample}
